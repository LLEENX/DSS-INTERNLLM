            ...
            {processingId.id !== null && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm transition-opacity">
                    <div className="bg-white p-8 rounded-2xl shadow-2xl flex flex-col items-center max-w-sm w-full mx-4 transform animate-pulse-slow">
                        {/* Spinner SVG */}
                        <svg className={`animate-spin h-14 w-14 mb-4 ${processingId.type === 'cv' ? 'text-orange-600' : 'text-emerald-600'}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
