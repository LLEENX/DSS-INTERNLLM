                                ...
                                {dataPelamar.length === 0 ? (
                                    ...
                                    dataPelamar.map((item, index) => (
                                        <tr key={index} className="hover:bg-gray-50/50 transition-colors group">
                                            ...
                                            {/* KOLOM AKSI (HAPUS) */}
                                            <td className="px-6 py-4 text-center">
                                                <button type="button" className="p-2 bg-red-50 text-red-500 rounded-lg border border-red-100 hover:bg-red-100 hover:text-red-600 transition-colors" title="Hapus Pelamar">
